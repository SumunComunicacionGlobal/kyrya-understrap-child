...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const n=e.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=E.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return i.enableDismissTrigger(E),e.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Vt);var Kt,Ut,Xt,Yt,Jt=Vt.exports;Kt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Ut=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Kt||Ut||Xt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1),jQuery(document).ready((function(e){e((function(){e('[data-bs-toggle="popover"]').popover().click((function(e){}))}));var t=e("body"),n=e("#main-nav").attr("class"),i=n;e("#main-nav .offcanvas").on("show.bs.offcanvas",(function(){i=e("#main-nav").attr("class"),e("#main-nav").removeClass("navbar-light").addClass("navbar-dark")})),e("#main-nav .offcanvas").on("hide.bs.offcanvas",(function(){e("#main-nav").removeClass("navbar-dark").addClass(i)})),jQuery(window).scroll((function(){e(window).scrollTop()>=25?(t.addClass("scrolled"),e("#main-nav").removeClass("navbar-dark").addClass("navbar-light bg-white")):(t.removeClass("scrolled"),e("#main-nav").removeClass("navbar-light bg-white").addClass(n)),e(window).scrollTop()+e(window).height()>e(document).height()-100?t.addClass("near-bottom"):t.removeClass("near-bottom")}))})),Yt=jQuery,jQuery(".wpcf7-uacf7_country_dropdown").each((function(){var e=jQuery(this).attr("id"),t=jQuery("#top-bar .wpml-ls-item-active").text();"en"==t&&(t="gb"),Yt("#"+e).countrySelect({defaultCountry:t,responsiveDropdown:!0,preferredCountries:["es","gb","fr","it","de","pt","us"]})})),jQuery(document).ready((function(e){e(".carrusel-post").carousel("cycle"),e(".carrusel-post").on("slide.bs.carousel",(function(t){e(this).find(".active").index();var n=e(t.relatedTarget).index();e(".carousel-indicators li.active").removeClass("active"),e(".carousel-indicators li").eq(n).addClass("active")})),e(".slick-slider").slick({infinite:!0,slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:3e3,arrows:!0,dots:!1}),e(".slick-product-slider").slick({infinite:!0,slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:4e3,arrows:!0,dots:!0,adaptiveHeight:!0})})),jQuery(document).ready((function(e){e(".wpcf7-list-item-label, label").each((function(t){var n=e(this).text().trim();if(n.indexOf("/*")>=0){var i=n.split("/*"),s="";e.each(i,(function(e,t){if("undefined"!=t){var n=t.split("*/");s+='<span class="show-lang-'+n[0]+'">'+n[1]+"</span>"}}));var o=e(this).html().trim();s+=o.substring(n.length),e(this).html(s)}})),e(".aparecer").each((function(t){var n=t+1;e(this).css("animation-delay",.04*n+"s")})),e(".aparecer").addClass("hidden").viewportChecker({classToAdd:"visible animated fadeInUp",offset:100});var t=e('input[name="kt"]'),n=e('input[name="kn"]');n.length&&(n.val().length>0?(e("#consulta-sobre").html("+ info: "+t.val()+" "+n.val()),e("#consulta-sobre").show()):e("#consulta-sobre").hide()),e(document).click((function(t){var n=e(t.target);"true"!==e("#navbar-toggler").attr("aria-expanded")||n.hasClass("navbar-toggler")||n.hasClass("nav-link")||n.hasClass("form-control")||e("#navbar-toggler").click()})),e(".close-modal").click((function(){e(".modal").toggleClass("show")}));var i=e(window);function s(){i.width()>767&&e(".modal-link").click((function(t){e("#modal-ajax-post").modal("show");var n=e("#modal-ajax-post .modal-body"),i=e(this).attr("href");t.preventDefault(),e(".modal").addClass("show",1e3,"easeOutSine"),n.html("loading..."),n.load(i+" #modal-ready",(function(){var t=window.location.origin;(t.includes("localhost")||t.includes("viral.sumun.net"))&&(t+="/kyrya"),e.getScript(t+"/wp-content/themes/kyrya-understrap-child/js/child-theme.min.js")}))}))}s(),e(window).resize(s)})),e.Alert=T,e.Button=k,e.Carousel=I,e.Collapse=M,e.Dropdown=vt,e.Modal=Lt,e.Offcanvas=jt,e.Popover=zt,e.Scrollspy=Bt,e.Tab=Qt,e.Toast=Jt,e.Tooltip=Rt}));
