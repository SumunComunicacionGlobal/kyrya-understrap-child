...
/**
 * Envía un lead a Zoho Campaigns cuando se envía el formulario con post_id 57056 o sus traducciones (WPML).
 */
...
function smn_send_lead_to_zoho_campaigns($contact_form) {
    ...
    // OAuth 2.0: obtener access token usando refresh token
    ...
    $refresh_token = '1000.1131c1a0fff3115b8320b125207b0d77.9ffd8f08c23b30461e52b756c4cd3d9a';
    $access_token = smn_zoho_get_access_token($client_id, $client_secret, $refresh_token);
    // $access_token = '1000.04c4b39d86e72c1c59f8477f4f9d562a.79e5f476c31a13bf4493bbb172d3b796';
    if (!$access_token) {
